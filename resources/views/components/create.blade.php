<div class="isolate relative bg-white px-6 py-20 sm:py-16 lg:px-8 md:w-1/2 h-full  rounded-xl my-10">
    <div class="absolute inset-x-0 top-[-10rem] -z-10 transform-gpu  blur-3xl sm:top-[-20rem]" aria-hidden="true">
