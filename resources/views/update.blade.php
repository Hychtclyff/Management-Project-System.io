<x-layout>
    ...
    <div
        class="flex justify-center  absolute top-0 left-1/2 -translate-x-1/2  w-screen h-screen overflow-scroll md:overflow-hidden bg-gray-600/5 backdrop-blur-sm">

        <div id="update" role="dialog" aria-hidden="true"
            class="isolate relative bg-white px-6 py-20 mx-5 md:mx-0 sm:py-16 lg:px-8 md:w-1/2 h-fit  rounded-xl my-10">
            <div class="absolute inset-x-0 top-[-10rem] -z-10 transform-gpu  md:overflow-hidden blur-3xl sm:top-[-20rem]"
                aria-hidden="true">
